    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/lib/bootstrap-table/bootstrap-table.js"></script>
	 ...
	 <script>
        ...
        function listTest(monitorSystem) {
			document.getElementById("iframe1").src = "/scheduler/listTest?monitorSystem="+monitorSystem; 
        };
         
        function hostsItems(monitorSystem) {
			document.getElementById("iframe1").src = "/hosts/hostsItems?monitorSystem="+monitorSystem; 
        };
        
        function toContactsList(monitorSystem) {
			document.getElementById("iframe1").src = "/contacts/toContactsList?monitorSystem="+monitorSystem; 
        };
        
        function toAddPage(){
			document.getElementById("iframe1").src = "/system/toAddSystem";
        }
        function toListPage(){
			document.getElementById("iframe1").src = "/system/systemList";
        }
