	...
	<div class="act-items">
		<div class="act-result-c">
			...
			<span class="add-reward"> <a
				href="/scheduler/listTest?monitorSystem=${monitorSystem }"
				class="btn white-btn">返回列表</a> </span>
			<span class="add-reward"> <a
				href="/hosts/toAddHostItems?hostSystem=${monitorSystem }"
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0"
			...
			<c:forEach var="psfHostArray" items="${psfHostArray}" >
				<tr>
					...
					<td>
						<a href='/hosts/toUpdateHostItems?hostId=${psfHostArray.hostId}'>编辑</a>
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0"
			...
			<c:forEach var="httpHostArray" items="${httpHostArray}" >
				<tr>
					...
					<td>
						<a href='/hosts/toUpdateHostItems?hostId=${httpHostArray.hostId}'>编辑</a>
