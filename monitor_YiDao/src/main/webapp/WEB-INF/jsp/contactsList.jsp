...
<body>
	<div class="act-items">
		<div class="act-result-c">
			...
			<span class="add-reward"> <a
				href="/contacts/toAddContacts?monitorSystem=${monitorSystem}"
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0"
			...
			<c:forEach var="monitorContacts" items="${monitorContacts}" >
				<tr>
					...
					<td>
						<a href='/contacts/toUpdateContacts?contactsId=${monitorContacts.contactsId}'>编辑</a>
