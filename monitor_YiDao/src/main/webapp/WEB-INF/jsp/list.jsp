        ...
        var tableData = [
            ...
            { 
                ...
                formatter:function(value, rows){
                    ...
                    return "<a href='javascript:;' class='js_view'>查看</a><a href='javascript:;' class='js_pause' id='start-stop'>"+stsp+"</a><a href='/scheduler/editMonitor?monitorId="+rows.monitorId+"' class='view js_edit'>编辑</a><a href='javascript:;' class='js_del'>删除</a>";
                },
                events:{
        ...
        var datagrid = {
            ...
            loadTable:function(){
                ...
                $('#main-list').bootstrapTable({
                    url: '/scheduler/listItems?monitorSystem=${monitorSystem}',
                    method : "get",
                    columns:tableData,
	...
	<div class="act-items">
		<div class="act-result-c">
			...
			<span class="add-reward"> <a
				href="/scheduler/toAddMonitor?monitorSystem=${monitorSystem}"
